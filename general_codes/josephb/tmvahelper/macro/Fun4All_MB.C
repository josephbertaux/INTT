...
int Fun4All_MB (
	...
	std::string outputKFParticleFile = defs::data_dir + "/output_MB_KFP_" + defs::channel + "_" + processID + ".root";
	std::string outputHFEffFile      = defs::data_dir + "/output_MB_HFE_" + defs::channel + "_" + processID + ".root";
	std::string outputDSTFile        = defs::data_dir + "/output_MB_DST_" + defs::channel + "_" + processID + ".root";
