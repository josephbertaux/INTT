...
arguments          = ${PWD}/macro/Fun4All_MB.C \$(process) ${NUM_EVT}

notification       = Never

output             = ${PWD}/out/gen_bak_\$(process)_${NUM_EVT}.out
error              = ${PWD}/out/gen_bak_\$(process)_${NUM_EVT}.out
log                = /tmp/${USR}_gen_bak_\$(process)_${NUM_EVT}.log
